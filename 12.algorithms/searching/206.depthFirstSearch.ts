...
function traverseInOrder(node: BSTNode, list: number[]) {
  if (node.left) {
...
function traversePreOrder(node: BSTNode, list: number[]) {
  list.push(node.value);
  if (node.left) {
...
function traversePostOrder(node: BSTNode, list: number[]) {
  if (node.left) {
